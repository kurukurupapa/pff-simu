...
public class Dp01Test {
	...
	public void testRun1_BattleItem0() {
		...
		mLogger.debug(dp.getParty());
		// 検証
		assertThat(dp.getParty().toString(), is("6213,パンネロ"));
	}
	...
	public void testRun1_Battle() {
		...
		// 検証
		assertThat(actual, is("" //
				+ "8893,パンネロ+ダンシングダガー+赤兎馬のたてがみ(レア5)+ケアル\n"
				+ "8499,トレイ+黄忠の長弓(レア5)+赤兎馬のたてがみ(レア5)+パワーリスト\n"
				+ "8050,ライトニング(No.119)+青紅の剣(レア5)+赤兎馬のたてがみ(レア5)+ケアル\n"
				// + "7256,トレイ+黄忠の長弓(レア5)+赤兎馬のたてがみ(レア5)+宿炎の指輪\n"
				+ "7159,アーロン+五月雨+赤兎馬のたてがみ(レア5)+エクサバックラー+アーロンLS\n"
				// + "7054,アーロン+烈風+赤兎馬のたてがみ(レア5)+SPの腕輪+アーロンLS\n"
				// + "7084,アーロン+五月雨+赤兎馬のたてがみ(レア5)+エクサバックラー+アーロンLS\n"
				// + "7054,アーロン+五月雨+赤兎馬のたてがみ(レア5)+SPの腕輪+アーロンLS\n"
				+ "6956,元帥シド+五月雨+マーシャルネイ+マーシャルネイ\n"
				// + "6916,トレイ+黄忠の長弓(レア5)+SPの腕輪+宿炎の指輪\n"
				// + "6854,アーロン+烈風+SPの腕輪+宿炎の指輪+アーロンLS\n"
				// + "6171,トレイ+ディバインアロー+SPの腕輪+宿炎の指輪\n"
				//+ "5870,アーシェ+オブリージュ+SPの腕輪+ケアル+アーシェLS\n"
				+ "5870,アーシェ+ネクロフォリア+SPの腕輪+ケアル+アーシェLS\n"
				// + "5820,元帥シド+烈風+マーシャルネイ+マーシャルネイ\n"
				// + "5820,元帥シド+五月雨+マーシャルネイ+マーシャルネイ\n"
				// + "5727,アーシェ+オブリージュ+SPの腕輪+ケアル+アーシェLS\n"
				+ "5674,ティナ+青紅の剣(レア5)+タイタン+ケアル\n"
				+ "5643,マキナ+青紅の剣(レア5)+赤兎馬のたてがみ(レア5)+パワーリスト\n"
				// + "5529,マキナ+青紅の剣(レア5)+赤兎馬のたてがみ(レア5)+エクサバックラー\n"
				// + "5512,ティナ+青紅の剣(レア5)+タイタン+ケアル\n"
				// + "5469,ライトニング(No.119)+青紅の剣(レア5)+赤兎馬のたてがみ(レア5)+ケアルラ\n"
				// + "4850,セシル+オブリージュ+赤兎馬のたてがみ(レア5)+エクサバックラー\n"
				//
				+ ""));
	}
	...
	public void testRun1_Battle_ThunderWeak() {
		...
		// 検証
		assertThat(actual, is("" //
		// + "10194,マキナ+閃光のウォーソード+赤兎馬のたてがみ(レア5)+雷の指輪"
		// + ",9860,ライトニング(No.119)+閃光のウォーソード+赤兎馬のたてがみ(レア5)+雷の指輪"
		// + ",8932,ティナ+閃光のウォーソード+赤兎馬のたてがみ(レア5)+雷の指輪"
		// 2015/06/13
				+ "12635,ライトニング(No.119)+閃光のウォーソード+パワーリスト+雷の指輪"
				+ ",10372,マキナ+閃光のウォーソード+パワーリスト+雷の指輪"
				+ ",9300,ティナ+閃光のウォーソード+パワーリスト+雷の指輪"
				//
				+ ""));
	}
	...
	public void testRun1_Battle_ThunderWeakPhysicalResistance() {
		...
		assertThat(actual, is("" //
		// 2015/04/28
		// + "4194,マキナ+閃光のウォーソード+赤兎馬のたてがみ(レア5)+雷の指輪\n"
		// + "3914,ヴァニラ+光の棒+ファイアRF+3+ケアル\n"
		// + "3900,ライトニング(No.119)+閃光のウォーソード+赤兎馬のたてがみ(レア5)+宿炎の指輪\n"
		// 2015/06/14
				+ "6947,パンネロ+ダンシングダガー+ファイアRF+3+ケアル\n"
				+ "6895,ライトニング(No.119)+閃光のウォーソード+赤兎馬のたてがみ(レア5)+パワーリスト\n"
				+ "4572,マキナ+閃光のウォーソード+赤兎馬のたてがみ(レア5)+パワーリスト\n"
				//
				+ ""));
	}
	...
	public void testRun_アクセサリ個数上限チェック() {
		...
		itemDataSet.addAccessoryData(mItemDataSet.find("チャクラバンド"));
