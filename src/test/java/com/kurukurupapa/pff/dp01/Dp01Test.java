...
public class Dp01Test {
	...
	public void testRun1_Battle_ThunderWeak() {
		...
		assertThat(actual, is("" //
				...
				// 2015/06/28
				+ "13438,ライトニング(No.119)+閃光のウォーソード+クリスタルの小手+雷の指輪\n" //
				+ "10667,マキナ+閃光のウォーソード+クリスタルの小手+雷の指輪\n" //
				+ "9857,元帥シド+おろち+マーシャルネイ+マーシャルネイ\n" //
				//
				+ ""));
	}
	...
	public void testRun1_Battle_ThunderWeakPhysicalResistance() {
		...
		assertThat(actual, is("" //
				...
				// 2015/06/28
				+ "7964,ライトニング(No.119)+閃光のウォーソード+パワーリスト+クリスタルの小手\n" //
				+ "7812,パンネロ+ダンシングダガー+クリスタルの小手+ファイアRF+3\n" //
				+ "7457,元帥シド+おろち+マーシャルネイ+マーシャルネイ\n" //
				//
				+ ""));
	}
