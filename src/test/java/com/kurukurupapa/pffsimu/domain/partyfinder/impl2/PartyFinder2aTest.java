...
import com.kurukurupapa.pffsimu.domain.partyfinder.impl2.PartyFinder2a;
import com.kurukurupapa.pffsimu.test.BaseTestCase;
import com.kurukurupapa.pffsimu.test.SlowTests;

public class PartyFinder2aTest extends BaseTestCase {
	...
	public void testRun1_Hp() {
		...
		PartyFinder2a pf;
		for (int i = 0; i < 3; i++) {
			pf = new PartyFinder2a(mMemoriaDataSet, mItemDataSet,
					fitnessCalculator);
			pf.run(1);
	...
	public void testRun2_Battle() {
		...
		// テスト実行
		PartyFinder2a pf;
		pf = new PartyFinder2a(mMemoriaDataSet, mItemDataSet, fitnessCalculator);
		pf.run2();
