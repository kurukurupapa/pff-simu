 ...
 * ・突然変異率：10%<br>
 */
public class MultiRouletteI050M010Main {
    ...
    public static void main(String[] args) {
        MultiRouletteI050M010Main main = new MultiRouletteI050M010Main();
        main.run(args);
    }
     ...
     * コンストラクタ
     */
    public MultiRouletteI050M010Main() {
        logger = Logger.getLogger(MultiRouletteI050M010Main.class);
    }
    ...
    public void run(String[] args) {
        ...
        mainService.setNumIndividuals(50);
