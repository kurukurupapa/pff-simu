 ...
 * ・突然変異率：50%<br>
 */
public class MultiRouletteI100M050Main {
    ...
    public static void main(String[] args) {
        MultiRouletteI100M050Main main = new MultiRouletteI100M050Main();
        main.run(args);
    }
     ...
     * コンストラクタ
     */
    public MultiRouletteI100M050Main() {
        logger = Logger.getLogger(MultiRouletteI100M050Main.class);
    }
    ...
    public void run(String[] args) {
        ...
        mainService.setMutationRate(0.5f);
